...
import { AppConfig, RouterWhiteList } from '~/config';
...
let JwtAuthGuard = class JwtAuthGuard extends AuthGuard(AuthStrategy.JWT) {
    constructor(reflector, authService, tokenService, redis, appConfig) {
        ...
        this.jwtFromRequestFn = ExtractJwt.fromAuthHeaderAsBearerToken();
    }
...
JwtAuthGuard = __decorate([
    Injectable(),
    __param(3, InjectRedis()),
    __param(4, Inject(AppConfig.KEY)),
